...
namespace Tempbre.Controllers
{
    ...
    public class SongsController : Controller
    {
        ...
        public ActionResult Search(string songSearch)
        {
            var songs = from s in db.Songs
                         select s;
            if (!String.IsNullOrEmpty(songSearch))
            {
                songs = songs.Where(s => s.Title.Contains(songSearch) || s.Comments.Contains(songSearch) || s.Genre.Contains(songSearch) || s.SubGenre.Contains(songSearch));
            }
